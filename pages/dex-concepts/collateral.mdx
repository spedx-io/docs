...
HxroNetwork's risk engine(see [Margining](/dex-concepts/margining)), and margin is posted in $USDC. Meaning that, currently the only asset
...
that using paper(artificial) profits as margin can be devastating in many cases, especially when those paper profits materialize into paper
losses and thus the collateral devalues incredibly. On how HxroNetwork manages this risk, see [Risk Management](/dex-concepts/risk-management)
