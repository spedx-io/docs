...
- If the margin required for the position is above the threshold of `3 _ 1d_standard_deviation _ order_size\*, the account is considered to be
  extremely healthy.
- If the margin required for the position is exactly at the of `3 _ 1d_standard_deviation _ order_size\*, the account is considered to be
  healthy.
...
`3/2 _ 1d_standard_deviation _ order_size`, the account is considered to be unhealthy.
...
When the margin levels of an account dips below the `3/2 _ 1d_standard_deviation _ order_size\*, the account is open for liquidation by liquidators.
...
- However, if the margin is still below the maintenance margin requirements of the user's postiions, positions are eligible to be liquidated
