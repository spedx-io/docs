...
The main idea is for the users to deposit into initiatives such as the [Market Maker](/market-maker), [Liquidator Client](/dex-concepts/liquidators) and the [Insurance Fund](/dex-concepts/insurance-fund)
