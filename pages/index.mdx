...
and the liquidity pool fully collateralizes these positions using the liquidity in the pool itself. However, such implementations have a few flaws:
...
- Funding rates can be badly understood. Funding rates in Orderbooks are a function of the deviation between the mark price and the index price.
  ...
  rates incredibly predictable and incredibly volatile in the case of poorly managed inventory and sub-park risk management.
