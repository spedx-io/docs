...
- If successful, the market maker can be ported to other derivatives platforms, leveraging our partnerships with Zeta Markets and Goose FX.
...
as specified in [Liqudations](/dex-concepts/liquidations), positions with maintenance margin level below the threshold of
